...
kubectl apply -f ../cluster/kube-ingress/kube-ingress-controller.yml

sleep 20

kubectl apply -f ../cluster/kube-ingress/kube-ingress-service.yml
...
kubectl create -f ../cluster/kube-ingress/kube-ingress-routes.yml
